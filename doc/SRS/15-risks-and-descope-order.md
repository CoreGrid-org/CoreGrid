...
| R-03 | ThunderID configuration or availability blocks authentication near evaluation. | L | H | The `IIdentityDirectory` abstraction and the configuration-selectable local fallback of Section 4.10, implemented and tested during the stabilisation week. |
